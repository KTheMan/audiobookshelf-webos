<template>
  ...
  <div v-else id="item-page" class="w-full h-full overflow-y-auto overflow-x-hidden relative bg-bg">
    ...
    <div class="w-full flex justify-center relative">
      ...
      <div class="relative" data-focusable @click="showFullscreenCover = true">
    ...
    <div class="relative">
      ...
      <div class="relative z-10 px-3 py-4">
        ...
        <div v-if="description" class="w-full py-2">
          ...
          <div v-if="descriptionClamped" class="text-fg text-sm py-2" data-focusable @click="showFullDescription = !showFullDescription">
...
import { AbsFileSystem, AbsDownloader } from '@/plugins/webos'
