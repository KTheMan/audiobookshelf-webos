<template>
  <div class="w-full h-full">
    ...
    <div v-if="$platform !== 'webos'" class="flex items-center justify-center pt-4 fixed bottom-4 left-0 right-0">
      <a href="https://github.com/ktheman/audiobookshelf-webos" target="_blank" class="text-sm pr-2">{{ $strings.MessageFollowTheProjectOnGithub }}</a>
      <a href="https://github.com/ktheman/audiobookshelf-webos" target="_blank"
